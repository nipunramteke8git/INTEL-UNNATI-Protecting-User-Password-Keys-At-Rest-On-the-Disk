...
def run_encryption(filepath, password, result_queue):
    success = encrypt_file(filepath, password)
...
def get_user_password(prompt):
    return tk.simpledialog.askstring("Password", prompt, show='*')

def confirm_password(password):
    confirmed_password = tk.simpledialog.askstring("Confirm Password", "Confirm your password:", show='*')
